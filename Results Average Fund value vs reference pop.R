...
rownames(Avg.Fund.Values) <- c("65", "75", "85", "95")

plot(x = seq_along(Avg.Fund.Values[1,]), y = Avg.Fund.Values[1,], 
     type = "n",
     xlab = "Years", 
     ylab = "Avg Fund Value", 
     main = "Average Fund Value over the years of the simulation with different choices for the starting age of the reference population 
